...
Item {
	...
	property list<SystemStateDescription> stateNames: [
		...
		SystemStateDescription { value: 0x0B; name: "psu"; text: qsTr("Power Supply Mode")},

		SystemStateDescription { value: 0xF5; name: "wakeup"; text: qsTr("Wakeup")},
		SystemStateDescription { value: 0xF6; name: "rep_abs"; text: qsTr("Repeated Absorption")},
		...
		SystemStateDescription { value: 0xFC; name: "hub1"; text: qsTr("External control")},
		...
		SystemStateDescription { value: 0x103; name: "scheduledcharge"; text: qsTr("Sched charge")}
	]
